        ...
        <div class="client-properties">
            @forelse($ventas as $venta)
                ...
                <article class="client-property-card">
                    <div class="client-property-image">@if($urbanizacion->plano_imagen)<img src="{{ Storage::disk('public')->url(ltrim(preg_replace('#^storage/#', '', $urbanizacion->plano_imagen), '/')) }}" alt="{{ $urbanizacion->nombre }}" loading="lazy">@else<span><i class="fa-regular fa-map"></i></span>@endif</div>
